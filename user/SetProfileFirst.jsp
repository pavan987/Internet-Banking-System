...
<form id="form1" name="form1" method="post" action="ValidateProfileFirst.jsp" onSubmit="return validateProfile(this)">
  <table width="100%" border="2" cellpadding="3" cellspacing="0" bordercolor="#000000" bgcolor="#F4FBFB">
    ...
    <tr>
      <td style="border:0;" align="center"><span class="style2" id="message"><%=message%></span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="border:0;"><table width="96%" border="1" align="center" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
          <tr>
            <td colspan="2"><span class="style9">Enter Profile Details : </span></td>
          </tr>
          <tr>
            <td width="27%">Enter Profile Password *</td>
            <td width="73%"><input name="password" type="password" id="password" maxlength="20" /></td>
          </tr>
          <tr>
            <td>Confirm Profile Password *</td>
            <td><input name="password1" type="password" id="password1" maxlength="20" /></td>
          </tr>
          <tr>
            <td>Hint Question * </td>
            <td><select name="que" id="que">
          ...
          <tr>
            <td>Hint Answer *</td>
            <td><input name="ans" type="text" id="ans" size="40" maxlength="40" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
