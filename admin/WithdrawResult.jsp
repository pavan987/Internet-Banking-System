...
db.updateSQL("insert into trans_info (accno,narration,debit,balance) values('"+accno+"','With draw Money',"+amount+","+updatedBal+")");
db.close();
...
<div id="container">
	...
	<tr>
	<td style="border:0" align="center"><span class="style2">Amount Withdrawn Successfully</span></td>
	</tr>
	</table>
	</div>
	</div>
