...
<div id="container">
  ...
  <tr>
    <td>
  <form action="Withdraw.jsp" method="post" enctype="application/x-www-form-urlencoded"  onsubmit="return validateForm(this)">
...
ResultSet rs=null;
  ...
  if(rs.next())
  {
     ...
     <form name="form2" method="post" action="WithdrawResult.jsp" onsubmit="return validateAmount(this)">
